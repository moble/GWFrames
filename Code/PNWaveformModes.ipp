...
GWFrames::PNWaveformModes::PNWaveformModes(const double idelta) :
...
/// Method to replace 'modes' with the waveform polarization data
void GWFrames::PNWaveformModes::operator()(const double v, const double chis, const double chia, std::vector<std::complex<double> >& modes) {
  double Re,Im;
  ...
  modes.resize(PNWaveforms_ellMax*(2+PNWaveforms_ellMax) - 3);
