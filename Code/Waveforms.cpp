...
public:
  ...
  Quaternions::Quaternion AvgLogRatio(const double deltat, const double deltax, const double deltay, const double deltaz) const {
    ...
    Quaternions::Quaternion avg(0.0, 0.0, 0.0, 0.0);
    Quaternions::Quaternion avgdot_last = Quaternions::log( aFrame[0] * Quaternions::inverse(bFrame[0]) );
    for(unsigned int i=1; i<Size; ++i) {
      const Quaternions::Quaternion avgdot = Quaternions::log( aFrame[i] * Quaternions::inverse(bFrame[i]) );
