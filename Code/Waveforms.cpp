...
// std::vector<GWFrames::Waveform> GWFrames::Waveforms::Extrapolate(std::vector<std::vector<double> >& Radii,
...
//   if(! FiniteRadiusWaveforms.CommonTimeSet) {
//     INFOTOCERR << "Common times not set; you need to use some function like `GWFrames.SetCommonTime` first." << std::endl;
//     throw(GWFrames_ValueError);
//   }
...
//   if(MaxN<0) { return ExtrapolatedWaveforms.WaveformVector(); }
...
//   return ExtrapolatedWaveforms.WaveformVector();
// }
