...
namespace WaveformUtilities {
  ...
  /// These functions return various noise curves as described e.g.,
  /// in LIGO-T0900288-v3, and fit by Collin Capano.
  ...
  std::vector<double> InverseNoiseCurve(const std::vector<double>& F,
                                        const std::string& Detector="AdvLIGO_ZeroDet_HighP",
                                        const double NoiseFloor=0.0);
