...
namespace GWFrames {
  ...
  std::vector<double> Component(const std::vector<GWFrames::Quaternion>& Q, const unsigned int i);
  std::vector<double> Component0(const std::vector<GWFrames::Quaternion>& Q);
