...
private:
  ...
  double Omega_precMag() const {
    ...
    // const double gamma = 5.51146384479718e-6*pow(v, 2)*(pow(v, 2)*(-60480.0*nu + v*(15120.0*chi1_l*(-6.0*delta*(delta + 1.0) + 5.0*delta*(delta + 2.0) + 5.0) + 15120.0*chi2_l*(-6.0*delta*(delta - 1.0) + 5.0*delta*(delta - 2.0) + 5.0) + v*(-982800.0*nu + v*(10080.0*chi1_l*(-18.0*delta*(delta + 1.0) + delta*(delta*(4.0*nu + 15.0) + 8.0*nu + 30.0) + 4.0*nu + 15.0) + 10080.0*chi2_l*(-18.0*delta*(delta - 1.0) - delta*(-delta*(4.0*nu + 15.0) + 8.0*nu + 30.0) + 4.0*nu + 15.0) + v*(-nu*(-560.0*nu*(4.0*nu + 2061.0) + 541013.822520207) + 3780.0*v*(chi1_l*(4.0*delta*(delta*(nu*(16.0*nu + 61.0) - 18.0) + nu*(16.0*nu + 61.0) - 18.0) + delta*(-delta*(nu*(72.0*nu + 127.0) - 60.0) - 2.0*nu*(72.0*nu + 127.0) + 120.0) - nu*(72.0*nu + 127.0) + 60.0) + chi2_l*(4.0*delta*(delta*(nu*(16.0*nu + 61.0) - 18.0) - nu*(16.0*nu + 61.0) + 18.0) + delta*(-delta*(nu*(72.0*nu + 127.0) - 60.0) + 2.0*nu*(72.0*nu + 127.0) - 120.0) - nu*(72.0*nu + 127.0) + 60.0)) + 181440.0)) + 181440.0)) + 181440.0) + 181440.0);
    // const double a_l_over_vcubed = 0.00694444444444444*pow(v, 4)*(36.0*chi1_n*(-6.0*delta*(delta + 1.0) + 7.0*delta*(delta + 2.0) + 7.0) + 36.0*chi2_n*(-6.0*delta*(delta - 1.0) + 7.0*delta*(delta - 2.0) + 7.0) + pow(v, 2)*(-12.0*chi1_n*(-9.0*delta*(delta*(3.0*nu + 4.0) + 3.0*nu + 4.0) + delta*(delta*(29.0*nu + 30.0) + 58.0*nu + 60.0) + 29.0*nu + 30.0) - 12.0*chi2_n*(9.0*delta*(-delta*(3.0*nu + 4.0) + 3.0*nu + 4.0) - delta*(-delta*(29.0*nu + 30.0) + 58.0*nu + 60.0) + 29.0*nu + 30.0) + pow(v, 2)*(chi1_n*(-3.0*delta*(delta*(nu*(68.0*nu + 219.0) + 36.0) + nu*(68.0*nu + 219.0) + 36.0) + delta*(delta*(nu*(208.0*nu + 531.0) + 54.0) + 2.0*nu*(208.0*nu + 531.0) + 108.0) + nu*(208.0*nu + 531.0) + 54.0) + chi2_n*(3.0*delta*(-delta*(nu*(68.0*nu + 219.0) + 36.0) + nu*(68.0*nu + 219.0) + 36.0) - delta*(-delta*(nu*(208.0*nu + 531.0) + 54.0) + 2.0*nu*(208.0*nu + 531.0) + 108.0) + nu*(208.0*nu + 531.0) + 54.0))));
    // return gamma*a_l_over_vcubed;
  }
  double Flux() const {
...
public:
  TaylorT1(const double idelta, const vector<double>& chi1_0, const vector<double>& chi2_0, const double v_0,
    ...
    // chi1_n(chi1_0[0]), chi2_n(chi2_0[0]), chi1_la(chi1_0[1]), chi2_la(chi2_0[1]), chi1_l(chi1_0[2]), chi2_l(chi2_0[2]),
  ...
  vector<double> L() const {
    ...
    const GWFrames::Quaternion l =
      ...
      // (0.005208333333333333*chi2_n* (-96.*(-1. + delta + 3.*nu)*powv3 -  2.*(-1. + delta)* (33. - 19.*nu + delta*(-99. + 39.*nu))*powv5 + (-1. + delta)* (-183. - 11.*(-121. + nu)*nu +  3.*delta*(183. + nu*(-933. + 7.*nu)))* powv7) + 0.005208333333333333*chi1_n* (96.*(1. + delta - 3.*nu)*powv3 -  2.*(1. + delta)* (-33. + 19.*nu + delta*(-99. + 39.*nu))* powv5 + (1. + delta)* (183. + 11.*(-121. + nu)*nu +  3.*delta*(183. + nu*(-933. + 7.*nu)))* powv7))*nHat
      // + (1. + 0.1666666666666667*(9. + nu)*powv2 +  0.04166666666666667*(81. + (-57. + nu)*nu)* powv4 + 0.0007716049382716049* (10935. + nu*(-40149.69585598816 + 1674.*nu +  7.*pownu2))*powv6 +  0.003472222222222222*chi1_l* (-240.*(5. + 5.*delta - 13.*nu)*powv3 +  7.*(1. + delta)* (-99. + 61.*nu + delta*(-153. + 121.*nu))* powv5 - 9.*(486. +  nu*(-2703. + 2.*(2059. - 59.*nu)*nu) +  delta*(486. + nu*(-1569. + 44.*nu)))*powv7 ) + 0.003472222222222222*chi2_l* (240.*(-5. + 5.*delta + 13.*nu)*powv3 +  7.*(-1. + delta)* (99. - 61.*nu + delta*(-153. + 121.*nu))* powv5 + 9.*(-486. +  delta*(486. + nu*(-1569. + 44.*nu)) +  nu*(2703. + 2.*nu*(-2059. + 59.*nu)))* powv7))*GWFrames::Quaternion(std::vector<double>(OmegaHat_orb,OmegaHat_orb+3))
      // + (0.02083333333333333*chi1_la* (-48.*(2. + 2.*delta - 5.*nu)*powv3 +  2.*(1. + delta)* (-21. - 27.*delta + 18.*nu + 34.*delta*nu)* powv5 + (-186. +  nu*(319. + 8.*nu*(33. + 16.*nu)) -  1.*delta*(186. + nu*(77. + 48.*nu)))*powv7 ) + 0.02083333333333333*chi2_la* (48.*(-2. + 2.*delta + 5.*nu)*powv3 +  2.*(-1. + delta)* (21. - 18.*nu + delta*(-27. + 34.*nu))*powv5 + (-186. +  nu*(319. + 8.*nu*(33. + 16.*nu)) +  delta*(186. + nu*(77. + 48.*nu)))*powv7))* lambdaHat;
    return ((nu/v)*l).vec();
  }
